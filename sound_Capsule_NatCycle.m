...
% Session, % Trial
    ...
    S.Session.SeedSeq =     [randperm(52), randperm(52)]; % music/speech total 52 sounds
    S.Trial.Names =         {'NatMatchST_full'};
...
list = list(idx);
list = [list(1:52); list(1:52)];

for i = 1:length(S.Session.SeedSeq)
