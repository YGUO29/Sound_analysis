...
data{2,1} = social.vad.tools.normMeanVar(parCallSpe - refCallSpe);
data{2,2} = social.vad.tools.normMeanVar(oneCallSpe);
Title = cell(2,2);
Title{1,1} = '(A) parabolic mic';
Title{1,2} = '(B) reference mic';
Title{2,1} = '(C) direct subtraction';
Title{2,2} = '(D) enhanced data';
%}
...
% %         T.AxesYLabel2 =           'Frequency difference limen (Hz)';
        ...
        T.AxesXLim =            [   1,  790];
        T.AxesYLim =            [   1, 257];
        T.AxesXTick =           [0, 200, 400, 600,790];
        T.AxesXTickLabel =      {'0', '0.2', '0.4', '0.6', '0.8'};
...
hBar = colorbar;
get(hBar, 'Position') 
set(hBar, 'Position', [0.8973    0.3590    0.0372    0.3611])
