...
%             119,132];
% ses_num = [199,204:207,209:212,214:218,220:224,226:230,232:236,238,239,241,242];
ses_num = [151,159,161];
...
for i = 1  : len_sessionNums
    ...
    filename    =   fullfile(param.soundFilePath,subject_fname,f);
...
%     sigOth{1} = session.Signals(3);
    temp = social.behavior.('ColonyParRefChannel')(session,subject_fname,sigPar,sigRef,sigOth,false,param);
