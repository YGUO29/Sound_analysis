...
%% Sound Seed
S.Seed.FolderParent =   'D:\SynologyDrive\=sounds=\Vocalization\';
...
% Session, % Trial
    ...
    S.Session.SeedSeq =     [randperm(36), randperm(36), randperm(36), randperm(36)];
    S.Trial.Names =         {'VocMatchSpec'};
...
list = dir(fullfile([S.Seed.FolderParent, '\LZ_AudFilt\PH\'],'*.wav'));
...
%     S.Seed.SoundRS{i,2} = S.Seed.SoundRS{i,2}/std(S.Seed.SoundRS{i,2});
   [S.Seed.SoundSpec{i}, ~] = audioread([ S.Seed.FolderParent,...
        '\LZ_ControlSounds\LZ_MatchSpec\PH\',...
        S.Seed.TitleSeeds{i,1}]);
    S.Seed.SoundRS{i,2} = resample(S.Seed.SoundSpec{i}, S.System.SR, S.Seed.FS);
    S.Seed.SoundRS{i,2} = S.Seed.SoundRS{i,2}/std(S.Seed.SoundRS{i,2});
